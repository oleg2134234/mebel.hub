...
# ================= UNFOLDED =================
# ПОЛОЖЕНИЕ ЛИНИЙ НЕ МЕНЯТЬ (Олег, 10.09.2026). Координаты зафиксированы на версии
# коммита 006f340; правки геометрии запрещены — только числа/кружки/плашки.
#   ширина спального 174 — прямой линией ПОД платформой во всю ширину;
#   глубина 198 — короткой диагональю снизу-слева.
